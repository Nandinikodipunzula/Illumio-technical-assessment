...
Note: I thought of writing Junit unit tests but the requirement was to submit a executable program without needing to download dependencies.
Hence I used very basic programming to accomplish this task
Processes only log files with version = 2
